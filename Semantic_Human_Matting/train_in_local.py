...
def get_args():
    ...
    parser.add_argument('--dataDir', default='D:/Peoplespace/AI_training/project/Semantic_Human_Matting/Semantic_Human_Matting/data', help='dataset directory')
    parser.add_argument('--saveDir', default='D:/Peoplespace/AI_training/project/Semantic_Human_Matting/Semantic_Human_Matting/ckpt', help='model save dir')
    parser.add_argument('--trainData', default='human_matting_data', help='train dataset name')
    parser.add_argument('--trainList', default='D:/Peoplespace/AI_training/project/Semantic_Human_Matting/Semantic_Human_Matting/data/list.txt', help='train img ID')
